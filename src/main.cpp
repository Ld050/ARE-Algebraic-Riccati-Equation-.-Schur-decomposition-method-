...
int main() {
    //читаем матрицы
    Matrix A = readMatrixFromFile("../data/A.txt");

    Matrix B = readMatrixFromFile("../data/B.txt");

    Matrix Q = readMatrixFromFile("../data/Q.txt");

    Matrix R = readMatrixFromFile("../data/R.txt");
