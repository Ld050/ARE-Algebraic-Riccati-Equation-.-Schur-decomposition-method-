...
2. (Опц.) Отбалансировать \(H\) методом Осборна.
3. Найти спектр и базис устойчивого инвариантного подпространства \(\mathcal{S}\) матрицы \(H\):
...
4. Решение ARE восстанавливается по формуле Шура:
   $$P = U_{21} U_{11}^{-1}.$$
